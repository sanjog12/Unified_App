...
import 'PPF/History.dart';
import 'PPF/Record.dart';

class FDScreen extends StatefulWidget {
  final Client client;
  FDScreen({this.client});
...
class _FDScreenState extends State<FDScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Fixed Deposit for ${widget.client.name}"),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              "Fixed Deposit for ${widget.client.name}",
              style: TextStyle(
                fontSize: 20.0,
              ),
            ),
