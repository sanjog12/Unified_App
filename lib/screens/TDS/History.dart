            ...
            Expanded(
              child: FutureBuilder<List<HistoryComplinceObject>>(
                future: HistoriesDatabaseHelper()
                    .getComplincesHistoryOfTDS(widget.client),
...
//													        },
  ...
  Future<void> getDetailedHistory(String key) async {
    if (key.isNotEmpty) {
      ...
      tdsPaymentObject = await SingleHistoryDatabaseHelper()
          .getTDSHistoryDetails(widget.client, key);
                  ...
                  TextButton(
                    ...
                    onPressed: () async {
                      ...
                      await dbf
                        ...
                        'nameOfForm': formTypeSelected == null
                            ? historyComplinceObject.amount
                            : formTypeSelected,
