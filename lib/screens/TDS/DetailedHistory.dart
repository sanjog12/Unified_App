...
class DetailedHistory extends StatefulWidget {
  ...
  const DetailedHistory(
      {Key key, this.keyDB, this.tdsPaymentObject, this.client})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Details of the payment paid  ${widget.tdsPaymentObject.dateOfPayment}',
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  edit
                      ? TextFormField(
                          initialValue: _tdsPaymentObject.BSRcode != null
                              ? _tdsPaymentObject.BSRcode
                              : "",
                      ...
                      : Container(
                          ...
                          child: widget.tdsPaymentObject.BSRcode != null
                              ? Text(
                                  widget.tdsPaymentObject.BSRcode,
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  edit
                      ? TextFormField(
                          initialValue:
                              widget.tdsPaymentObject.challanNumber != null
                                  ? widget.tdsPaymentObject.challanNumber
                                  : "",
                          onChanged: (String value) {
