...
class _HistoryESIState extends State<HistoryESI> {
            ...
            Expanded(
              child: FutureBuilder<List<HistoryComplinceObject>>(
                future: HistoriesDatabaseHelper()
                    .getComplincesHistoryOfESI(widget.client),
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(snapshot.data[index].type != null
                                  ...
                                  : ' '),
                              trailing: Text(snapshot.data[index].amount != null
  ...
  Future<void> getCompleteDetails(String key) async {
    if (key.isNotEmpty) {
      ...
      esiMonthlyContributionObejct = await SingleHistoryDatabaseHelper()
          .getESIHistoryDetails(widget.client, key);
