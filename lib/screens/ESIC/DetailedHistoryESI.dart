...
class DetailedHistoryESI extends StatefulWidget {
  ...
  const DetailedHistoryESI(
      {Key key, this.keyDB, this.client, this.esiMonthlyContributionObejct})
      : super(key: key);
            ...
            children: <Widget>[
                                ...
                                onPressed: () async {
                                  selectedDate =
                                      await DateChange.selectDateTime(
                                          context, 1, 1);
                                  setState(() {
                                    selectedDateDB = DateFormat('dd-MM-yyyy')
                                        .format(selectedDate);
                                    _esiMonthlyContributionObejct
                                        .dateOfFilling = selectedDateDB;
                                  });
                                },
                  ...
                  edit
                      ? TextFormField(
                          ...
                          decoration: buildCustomInput(
                              ...
                              prefixText: "\u{20B9}"),
                          onChanged: (String value) {
                            _esiMonthlyContributionObejct.amountOfPayment =
                                value;
                          },
                        )
                      : Container(
                          ...
                          child: Text(
                            "\u{20B9} " +
                                widget.esiMonthlyContributionObejct
                                    .amountOfPayment,
                            style: TextStyle(color: Colors.white),
                          ),
                        )
              ...
              edit
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: <Widget>[
                        Text(_esiMonthlyContributionObejct.addAttachment != null
                            ? 'Add New File'
                            : "Add File"),
                        SizedBox(
                          height: 10,
                  ...
                  onPressed: () async {
                    try {
                      ...
                      String path = firebaseStorage
                          ...
                          .child('files')
                          .child(
                              widget.esiMonthlyContributionObejct.addAttachment)
                          .fullPath;
