...
class GSTPayment extends StatefulWidget {
  ...
  const GSTPayment({Key key, this.upComingComplianceObject, this.client})
      : super(key: key);
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  'GST',
                  style:
                      _theme.textTheme.headline6.merge(TextStyle(fontSize: 28)),
                ),
                SizedBox(
                  height: 10,
                ),
                Text(
                  'Enter your details to make payment for GST',
                  style:
                      _theme.textTheme.bodyText2.merge(TextStyle(fontSize: 15)),
                ),
                SizedBox(
                  height: 50,
                ),
                ...
                (gstPaymentObject.section != "GSTR 1" &&
                        gstPaymentObject.section != "GSTR 3B")
                    ? Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: <Widget>[
                          Text('Challan Number'),
                          ...
                          TextButton(
                            onPressed: () async {
                              ...
                              setState(() {
                                ...
                                _showDateOfPayment = DateFormat('dd-MM-yyyy')
                                    .format(selectedDateOfPayment);
                              });
                            },
