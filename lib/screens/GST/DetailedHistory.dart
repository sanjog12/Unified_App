...
class DetailedHistoryGst extends StatefulWidget {
  ...
  const DetailedHistoryGst(
      {Key key, this.keyBD, this.client, this.gstPaymentObject})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                widget.client.name + '\'s GST Payment Details',
                style: TextStyle(
                  fontSize: 25,
              ...
              edit
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: <Widget>[
                        Text(_gstPaymentObject.addAttachment != "null"
                            ? "Add New File"
                            : "Add challan PDF"),
                        SizedBox(
                          height: 10,
