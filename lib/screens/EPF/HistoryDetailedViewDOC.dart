...
class EPFRecordHistoryDetailsView2 extends StatefulWidget {
  ...
  const EPFRecordHistoryDetailsView2(
      {this.client, this.epfDetailsOfContributionObject, this.keyDB});
                ...
                children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      edit
                                    ...
                                    onPressed: () async {
                                      selectedDate =
                                          await DateChange.selectDateTime(
                                              context, 1, 1);
                                      setState(() {
                                        _epfDetailsOfContributionObject
                                                .dateOfFilling =
                          ...
                          : Container(
                              ...
                              decoration: fieldsDecoration,
                              child: Text(
                                widget.epfDetailsOfContributionObject
                                    .dateOfFilling,
                                style: TextStyle(
                                  color: whiteColor,
                                ),
                  ...
                  edit
                      ? Column(
                          ...
                          children: <Widget>[
                            Text(
                                _epfDetailsOfContributionObject.addAttachment !=
                                        null
                                    ? 'Add New File'
                                    : "Add File"),
                            SizedBox(
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    try {
                      ...
                      setState(() {
                        widget.epfDetailsOfContributionObject.addAttachment =
                            "null";
                      });
